...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const App = {
        ...
        notesBtn: document.querySelector('.notes-btn'),
                ...
                summaryLoading: document.createElement('div'), // Add loading element
            };
            this.elements.summaryLoading.classList.add('typing-indicator', 'active');
            this.elements.summaryLoading.innerHTML = '<span></span><span></span><span></span>';
        },
        ...
        setupEventListeners() {
            ...
            this.elements.notesBtn.addEventListener('click', () => { window.location.href = '/notes'; });
            this.elements.notesBtn.addEventListener('keydown', (e) => onKey(e, () => { window.location.href = '/notes'; }));
            ...
            this.elements.mobileChatBtn.addEventListener('click', this.activateChatView.bind(this));

            // Chat form listener
            this.elements.chatForm.addEventListener('submit', this.handleChatSubmit.bind(this));
            this.elements.closeChatBtn.addEventListener('click', this.deactivateChatView.bind(this));
        ...
        startMessageIntervals() {
            ...
            this.state.intervals.mood = setInterval(() => this.updateRandomMessage(this.elements.moodIndicator, this.messages.mood), 8000);
        },
        ...
        async handleChatSubmit(e) {
            ...
            let response = await fetch("/ai", {
                ...
                body: JSON.stringify({
                    userPrompt: message || "Hey what's up how are u" ,
                    audioRes:false
                }),
            });
        ...
        appendMessage(text, sender) {
            ...
            messageElement.innerHTML = sanitize(text);
        ...
        async handleSummaryClick() {
            ...
            this.elements.summaryModal.appendChild(this.elements.summaryLoading);
        ...
        async populateSummary() {
            this.elements.summaryPlaceholder.style.display = 'none';
            this.elements.summaryLoading.remove(); // Remove loading indicator
             
            const response =  await fetch("/getSum")

            const summarie =  await response.json()
            ...
            this.elements.summaryResult.innerHTML = summarie.message;
